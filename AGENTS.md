...
- **Queue Operations:** Avoid `Array.prototype.shift()` in performance-critical loops. Use an index pointer or a proper Queue data structure to ensure O(1) dequeue operations.
