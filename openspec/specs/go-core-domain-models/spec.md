...
This document defines the core domain models for a task execution framework in Go. It outlines the essential interfaces and types required to implement a flexible and extensible task runner that can manage various tasks with shared state and context propagation.
