...
Execution strategies provide different modes of running individual tasks in the task-runner, including standard execution, retry with backoff, and dry-run (no-op) execution.
